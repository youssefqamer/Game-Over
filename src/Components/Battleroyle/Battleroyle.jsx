...
import styles from './Battleroyle.module.scss'
...
export default function Battleroyle() {
  let {getgames,getGames,seeMore,seeLess,numberOfGames,loading}=useContext(dataContext)
  useEffect(() => {
    getGames("https://free-to-play-games-database.p.rapidapi.com/api/games?category=battle-royale")
  }, [])
  return (
    <>
